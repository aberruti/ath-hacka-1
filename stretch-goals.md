...
Add the skill to the coordinator's skill list. Re-run the deal. The output should now sound like _your_ firm wrote it.
...
**Why this lands:** Shows how to use multi-agent for _judgment_ problems, not just task parallelism.
